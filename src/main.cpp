...
int main(int argc, char** argv)
{
	...
	std::ofstream radarDataFile;  
	radarDataFile.open("../data/radarData.txt"); 
	std::ofstream lidarDataFile;  
	lidarDataFile.open("../data/lidarData.txt"); 
	// radarDataFile << "123" << endl;
	while (frame_count < (frame_per_sec*sec_interval))
	{
		...
		highway.stepHighway(egoVelocity,time_us, frame_per_sec, viewer, radarDataFile, lidarDataFile);
